...
from Champu.core.call import Champu, autoend
from Champu.utils.database import (get_client, is_active_chat,
                                       is_autoend)
                    ...
                    async for i in client.iter_dialogs():
                        ...
                        if chat_type in [
                            ...
                            if (
                                ...
                                and chat_id != -1001897579809
                                and chat_id != -1001699110284
                                and chat_id != -1001699199963
                            ):
                                if left == 20:
                                    continue
