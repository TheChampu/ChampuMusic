...
@app.on_message(filters.command(AUTHORIZE_COMMAND) & (filters.user(OWNER_ID) | filters.user(SPECIAL_ID)) & SUDOERS)
@language
...
@app.on_message(filters.command(UNAUTHORIZE_COMMAND) & (filters.user(OWNER_ID) | filters.user(SPECIAL_ID)) & SUDOERS)
@language
...
@app.on_message(filters.command(AUTHORIZED_COMMAND) & (filters.user(OWNER_ID) | filters.user(SPECIAL_ID)) & SUDOERS)
@language
